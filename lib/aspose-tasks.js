...
AsposeTasks.prototype.getTasks = function(fileName, folderName, callback){
...
AsposeTasks.prototype.addTask = function(fileName, taskName, beforeTaskId, callback){
    ...
    var strURI = this.baseURI + 'tasks/' + fileName + '/tasks?taskName='+taskName;
    if (beforeTaskId !== '') {
        strURI += '&beforeTaskId=' + beforeTaskId;
    }
    var signedURI = Utils.Sign(strURI,this.appSID,this.appKey);
